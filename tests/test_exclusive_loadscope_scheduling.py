...
def mock_exclusive_load_scope_scheduling():
    ...
    with patch("xdist.scheduler.loadfile.LoadScopeScheduling.__init__", return_value=None):
        ...
        with patch(
            "xdist_scheduling_exclusive.scheduler_base.load_exclusive_tests",
            return_value={"test_exclusive_1", "test_exclusive_2"},
        ):
            ...
            exclusive_load_scope_scheduling.workqueue = OrderedDict(
                [
                    ...
                    ("another_scope", {"test_mock_exclusive.py::test_exclusive_2": False}),
                ]
            )
...
def test_exclusive_test_scheduling(mock_exclusive_load_scope_scheduling):
    ...
    mock_exclusive_load_scope_scheduling.workqueue.update({"mock_scope": mock_work_unit})
